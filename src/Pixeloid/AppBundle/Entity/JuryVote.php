...
/**
 * @ORM\Entity(repositoryClass="Pixeloid\AppBundle\Repository\JuryVoteRepository")
 */
class JuryVote
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Pixeloid\AppBundle\Entity\EventRegistration", inversedBy="juryvotes")
     * @ORM\JoinColumn(nullable=false)
     */
    private $eventRegistration;

    /**
     * @ORM\ManyToOne(targetEntity="Pixeloid\AppBundle\Entity\User", inversedBy="juryVotes")
     * @ORM\JoinColumn(nullable=false)
     */
    private $user;
