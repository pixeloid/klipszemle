 ...
 */
final class Version20190919114611 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE SiteUser DROP votesheet_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE SiteUser ADD votesheet_id INT DEFAULT NULL');
