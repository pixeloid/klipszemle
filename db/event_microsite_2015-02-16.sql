...
# Generation Time: 2015-02-16 22:20:19 +0000
# ************************************************************
...
VALUES
	...
	(2,'mgyaitt','2015-05-24','2015-05-25',NULL,NULL,'mgyaitt');
...
CREATE TABLE `EventRegistration` (
  ...
  `invoiceType_sponsored` int(11) DEFAULT NULL,
...
INSERT INTO `EventRegistration` (`id`, `user_id`, `firstname`, `lastname`, `title`, `institution`, `country`, `address`, `phone`, `fax`, `email`, `city`, `postal`, `registrant_type_id`, `regnumber`, `event_id`, `paymentmethod`, `invoiceType_sponsored`, `billingName_sponsored`, `billingAddress_sponsored`, `billingContactPerson_sponsored`, `billingName_transfer`, `billingAddress_transfer`)
VALUES
	(1,1,'kiss','Bél','Mr.','qwrfwerf0','AF','werfwerfwer','12341234',NULL,'werfw@sdfvsd.hu','werfgwerfgwerf','24',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL),
	(2,1,'kiss','Bél','Mr.','qwrfwerf0','AF','werfwerfwer','12341234',NULL,'werfw@sdfvsd.hu','werfgwerfgwerf','24',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL),
	(3,1,'kiss','Bél','Mr.','qwrfwerf0','AF','werfwerfwer','12341234',NULL,'werfw@sdfvsd.hu','werfgwerfgwerf','24',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL),
	(4,1,'kiss','Bél','Mr.','qwrfwerf0','AF','werfwerfwer','12341234',NULL,'werfw@sdfvsd.hu','werfgwerfgwerf','24',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL),
	(5,2,'Oláh','Gergely','Mr.','qwrfwerf0','AL','werfwerfwer','+36709439436',NULL,'olah.gergely@pixeloid.hu','werfgwerfgwerf','24',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL);
